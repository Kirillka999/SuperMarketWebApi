        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoHash = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductInfo_ProductCategory_CategoryIdId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StatusIdId = table.Column<int>(type: "integer", nullable: false),
                    InstantPrice = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_OrderStatus_StatusIdId",
                        column: x => x.StatusIdId,
                        principalTable: "OrderStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Order_ProductInfo_ProductIdId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_StatusIdId",
                table: "Order",
                column: "StatusIdId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductInfo_CategoryIdId",
                table: "ProductInfo",
                column: "CategoryIdId");
        }
